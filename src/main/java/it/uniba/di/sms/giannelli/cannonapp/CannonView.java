...
package it.uniba.di.sms.giannelli.cannonapp;
...
import it.uniba.di.sms.giannelli.R;
...
public class CannonView extends SurfaceView implements
   ...
   public CannonView(Context context, AttributeSet attrs)
   {
      ...
      cannonBarrelPaint = new Paint();
      cannonBarrelPaint.setColor(Color.WHITE);
   ...
   protected void onSizeChanged(int w, int h, int oldw, int oldh) {
      ...
      cannonPaint.setStrokeWidth(lineWidth * 0.4f); // set line thickness

      cannonPaint.setStyle(Paint.Style.STROKE);
      cannonBarrelPaint.setStrokeWidth(w/36);
